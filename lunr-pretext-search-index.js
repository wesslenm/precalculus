...
},
{
  ...
  "body": "Interactive graph activity  Click the link to see an interactive graph of a dynamic exponential function. Use the sliders for the parameters and to see how different values of these parameters change the shape of the exponential graph.   Interactive Graph Activity   What do you notice for different values or types of values of ?   What do you notice when     Or when ?    What does the graph look like when ?    What about when ?    What about when ?     What do you notice for different values of ? Can you determine different \"cases\" for ? (Are there different groups of values of that behave differently?)  "
},
{
  ...
  "body": "Exponential graphs   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   A    B    C    D     (Click on graph to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the function with the greatest -intercept, , has the largest .      "
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs.",
  "body": "Exponential graphs   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   C    A    B    D     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
...
},
{
  ...
  "body": "Equal value for   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A , B , C , and D , can all be written in the form .  Which two functions have the same value for ?   BC    AB    BD    AC    CD    AD     (click on image to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the two functions with the same y -intercept, are B and D.      "
},
{
...
},
{
  ...
  "body": "Sketch the graph    Without a calculator, sketch the first two periods of the graph of the function .  Which graph below A-E matches your sketch?   D    Choose    B    C    E    A              A  B            C  D           E      (Click on a graph to enlarge it)   SOLUTION The function has midline and amplitude . Since , the period is Since this is a cosine function with a negative value for the parameter , when the graph is at its minimum value. Therefore the correct answer is graph D .      "
},
{
