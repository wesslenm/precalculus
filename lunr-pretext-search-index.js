...
},
{
  ...
  "body": "Exponential graphs - FROM WEBWORK    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   C    A    B    D     (Click on graph to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the function with the greatest -intercept, , has the largest .      "
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs - FROM WEBWORK.",
  "body": "Exponential graphs - FROM WEBWORK    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   D    C    A    B     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
...
},
{
  ...
  "number": "2.1.5.2",
  "title": "True or False? - HOMEMADE.",
  "body": "True or False? - HOMEMADE   (Not randomizable)     Which of the following statements are true, and which are false?    If then   True   False     There is exactly one real number such that   True   False     for all numbers and   True   False     for all numbers and   True   False       True   False       True   False                                        "
},
{
...
},
{
  ...
  "body": "Largest value for - FROM WEBWORK    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   D    C    B    A     (Click on graph to enlarge)   SOLUTION The function with the largest should be the one that is increasing the fastest. We note that C increases faster than the others, so C has the largest .      "
},
{
  ...
  "type": "Exercise",
  "number": "2.1.5.5",
  "title": "Transformations - FROM WEBWORK.",
  "body": "Transformations - FROM WEBWORK    The graph of the function can be obtained from the graph of by two of the following actions:  (a) reflecting the graph of in the -axis;  (b) reflecting the graph of in the -axis;  (c) shifting the graph of to the right 5 units;  (d) shifting the graph of to the left 5 units;  (e) shifting the graph of upward 5 units;  (f) shifting the graph of downward 5 units;  Your answer: Apply the action (input a, b, c, d, e, or f) then apply the action  (please give your answer in the order the changes are applied, e.g. a first, then b second)  The range of the function is , find .  The value of is  Is the domain of the function still ?  Your answer is (input Yes or No)    a         Yes    f       "
},
{
  ...
  "body": "Domain - FROM WEBWORK    Find the domain of each function. If the answer is all real numbers, enter \"r\" below.  (a)  (b)  (a)   (b)                  "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "2.1.5.9",
  "title": "Function Expression - HOMEMADE.",
...
},
{
  ...
  "number": "2.2.5.2",
  "title": "Write in logarithmic form - HOMEMADE.",
  "body": "Write in logarithmic form - HOMEMADE    Write each of the following in logarithmic form.     This is equivalent to where  and  and  .     This is equivalent to where  and  and  .     This is equivalent to where  and  and  .                                                      "
},
{
  "id": "sec-exp-log-9-5",
  "level": "2",
...
},
{
  ...
  "type": "Exercise",
  "number": "2.2.5.5",
  "title": "Function characteristics - HOMEMADE - need to finish.",
  "body": "Function characteristics - HOMEMADE - need to finish        The graph of a logarithmic function is given above. Answer the following questions about that graph.   What is the domain of the function, in interval notation? .    What is the range of the function, in interval notation? .    What is the -intercept of the function? . (Enter your answer in point form, for example )    What is the equation of the vertical asymptote? The vertical asymptote is  . (Enter a single number.)                             "
},
{
  "id": "sec-exp-log-10-3",
  "level": "2",
...
},
{
  ...
  "number": "2.3.3.4",
  "title": "Using properties to evaluate - HOMEMADE.",
  "body": "Using properties to evaluate - HOMEMADE    Simplify the following as much as possible without using a calculator. Assume al logarithm arguments are positive (so you do not need to worry about domains).                                   "
},
{
...
},
{
  ...
  "type": "Checkpoint",
  "number": "2.35",
  "title": "A basic exponential equation - FROM WEBWORK.",
  "body": "A basic exponential equation - FROM WEBWORK    Use logarithms to find an exact solution to the equation below.           SOLUTION Using the log rules, we have       "
},
{
  ...
  "type": "Checkpoint",
  "number": "2.36",
  "title": "Exponential equation - FROM WEBWORK.",
  "body": "Exponential equation - FROM WEBWORK    Find the exact solution to the equation below. (Do not give a decimal approximation.)           SOLUTION First we isolate the exponent: so that Once the exponent isolated we use logs and solve for :       "
},
{
  ...
  "type": "Checkpoint",
  "number": "2.37",
  "title": "Logarithmic equation - FROM WEBWORK.",
  "body": "Logarithmic equation - FROM WEBWORK    Find the exact solution to the equation below. (Do not give a decimal approximation.)           SOLUTION First we isolate the natural log:  Now we can rewrite in exponential form and solve for x :   . Now we check our solution:  which is the result we want.      "
},
{
  ...
  "type": "Checkpoint",
  "number": "2.38",
  "title": "Logarithmic equation and round the answer - FROM WEBWORK.",
  "body": "Logarithmic equation and round the answer - FROM WEBWORK    Find the solution of the logarithmic equation in terms of logarithms, or correct to four decimal places.  Your answer is              "
},
{
  ...
  "type": "Checkpoint",
  "number": "2.39",
  "title": "A logarithmic equation - FROM WEBWORK.",
  "body": "A logarithmic equation - FROM WEBWORK    Find the solution of the logarithmic equation correct to four decimal places.  Your answer is              "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.1",
  "title": "A basic equation - FROM WEBWORK.",
  "body": "A basic equation - FROM WEBWORK    Solve the following equation. If necessary, enter your answer as an expression involving natural logarithms or as a decimal approximation that is correct to at least four decimal places.               "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.2",
  "title": "Basic equations - FROM WEBWORK.",
  "body": "Basic equations - FROM WEBWORK    Solve each equation for .  (a)  (b)  (a)  (b)                 "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.3",
  "title": "Solve the equations - FROM WEBWORK.",
  "body": "Solve the equations - FROM WEBWORK    Solve each equation for .  (a)  (b)  (a)  (b)                 "
},
{
  ...
  "number": "2.4.4.4",
  "title": "Logarithmic equation - FROM WEBWORK.",
  "body": "Logarithmic equation - FROM WEBWORK    Solve for the unknown variable.           . Thus, or . Hence, .      "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.5",
  "title": "Logarithmic equation with compositions - FROM WEBWORK.",
  "body": "Logarithmic equation with compositions - FROM WEBWORK    Solve the equation for . Answer:             "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.6",
  "title": "An equation with <span class=\"process-math\">\\(x\\)<\/span> appearing twice - FROM WEBWORK.",
  "body": "An equation with appearing twice - FROM WEBWORK    Solve the equation              "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.7",
  "title": "Two equations - FROM WEBWORK.",
  "body": "Two equations - FROM WEBWORK    Solve each equation for .  (a)  (b)  (a)  (b)                 "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.4.8",
  "title": "Challenge: An exponential equation - FROM WEBWORK.",
  "body": "Challenge: An exponential equation - FROM WEBWORK    Find the solutions of the exponential equation  Enter your answer as a comma-separated list, and enter none if there are no solutions.            "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.5.1",
  "title": "Inequalties - FROM WEBWORK.",
  "body": "Inequalties - FROM WEBWORK    Solve each inequality for .  (a)  (b)  (a)   (b)                  "
},
{
  ...
  "type": "Exercise",
  "number": "2.4.5.2",
  "title": "More inequalties - FROM WEBWORK.",
  "body": "More inequalties - FROM WEBWORK    Solve each inequality for .  (a)  (b)  (a)    (b)                       "
},
{
  "id": "sec-trig-intro",
  "level": "1",
...
},
{
  ...
  "type": "Exercise",
  "number": "3.2.5.4",
  "title": "Which function - FROM WEBWORK.",
  "body": "Which function - FROM WEBWORK    Which function is described by the plot below?                    none of the above              "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "3.3.5.1",
  "title": "Evaluate at common angles - HOMEMADE.",
  "body": "Evaluate at common angles - HOMEMADE   (Not randomized.)     Evaluate the following without using a calculator. Use one of the techniques discussed in this section, as appropriate.  (a)  .  (b)  .  (c)  .                      "
},
{
  ...
  "type": "Exercise",
  "number": "3.3.5.2",
  "title": "Evaluate at <span class=\"process-math\">\\(-\\frac{\\pi}{3}\\)<\/span> - HOMEMADE.",
  "body": "Evaluate at - HOMEMADE   (Not randomized.)     Evaluate the following without using a calculator. Use one of the techniques discussed in this section, as appropriate.  (a)  .  (b)  .                 "
},
{
  ...
  "type": "Exercise",
  "number": "3.3.5.3",
  "title": "Evaluate at <span class=\"process-math\">\\(\\frac{7\\pi}{6}\\)<\/span> - HOMEMADE.",
  "body": "Evaluate at - HOMEMADE   (Not randomized.)     Evaluate the following without using a calculator. Use one of the techniques discussed in this section, as appropriate.  (a)  .  (b)  .                 "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "3.3.5.5",
  "title": "Evaluate at <span class=\"process-math\">\\(0\\)<\/span> - FROM WEBWORK.",
  "body": "Evaluate at - FROM WEBWORK   (Not randomized.) Evaluate the following without using a calculator. Use one of the techniques discussed in this section, as appropriate.     If an answer is undefined, input undefined .   ;   ;   ;   ;   ;   ;                                     "
},
{
  ...
  "type": "Exercise",
  "number": "3.3.5.6",
  "title": "Evaluate cosine at multiples of <span class=\"process-math\">\\(\\frac{\\pi}{2}\\)<\/span> - HOMEMADE.",
  "body": "Evaluate cosine at multiples of - HOMEMADE    Evaluate without using a calculator.   .            "
},
{
