...
},
{
  ...
  "body": "Exponential graphs   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   D    C    A    B     (Click on graph to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the function with the greatest -intercept, , has the largest .      "
},
{
...
},
{
  ...
  "body": "Equal value for   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A , B , C , and D , can all be written in the form .  Which two functions have the same value for ?   AD    CD    AC    BD    AB    BC     (click on image to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the two functions with the same y -intercept, are B and D.      "
},
{
  ...
  "body": "Largest value for   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   C    B    A    D     (Click on graph to enlarge)   SOLUTION The function with the largest should be the one that is increasing the fastest. We note that C increases faster than the others, so C has the largest .      "
},
{
...
},
{
  ...
  "body": "Interpreting Logarithms      is read out as ``log base , of    is read out as ``log base , of                             "
},
{
  "id": "sec-exp-log-6-9",
  "level": "2",
...
},
{
  ...
  "number": "2.18",
  "title": "Write in logarithmic form.",
  "body": "Write in logarithmic form    Write each of the following in logarithmic form.    This is equivalent to where  and  .     This is equivalent to where  and  .     This is equivalent to where  and  .     This is equivalent to where  and  .     This is equivalent to where  and  .                                                           "
},
{
  "id": "sec-exp-log-6-12",
  "level": "2",
...
},
{
  ...
  "number": "2.2.5.2",
  "title": "Write in logarithmic form.",
  "body": "Write in logarithmic form    Write each of the following in logarithmic form.     This is equivalent to where  and  and  .     This is equivalent to where  and  and  .     This is equivalent to where  and  and  .                                                      "
},
{
  "id": "sec-exp-log-9-5",
  "level": "2",
...
},
{
  ...
  "number": "2.2.5.4",
  "title": "Domain.",
  "body": "Domain    Find (a) the domain of and (b) .   (a)   (b)                  "
},
{
  "id": "sec-exp-log-9-7",
  "level": "2",
  ...
  "body": "Function characteristics - need to finish        The graph of a logarithmic function is given above. Answer the following questions about that graph.   What is the domain of the function, in interval notation? .    What is the range of the function, in interval notation? .    What is the -intercept of the function? . (Enter your answer in point form, for example )    What is the equation of the vertical asymptote? The vertical asymptote is  . (Enter a single number.)                             "
},
{
  "id": "sec-exp-log-10-3",
  "level": "2",
...
},
{
  ...
  "number": "2.3.3.3",
  "title": "True or False?",
  "body": "True or False?   (Not randomizable)     Suppose and are positive numbers. Which of the following statements are true, and which are false?      True   False       True   False     If then   True   False     If then   True   False       True   False       True   False   Note: If we wanted two terms inside the logarithm function, we would need to write                                       "
},
{
...
{
  "id": "sec-exp-solve-8-9",
  "level": "2",
  "url": "sec-exp-solve.html#sec-exp-solve-8-9",
  "type": "Exercise",
  "number": "2.4.4.7",
  "title": "Two equations.",
...
{
  "id": "sec-exp-solve-8-10",
  "level": "2",
  "url": "sec-exp-solve.html#sec-exp-solve-8-10",
  "type": "Exercise",
  "number": "2.4.4.8",
...
},
{
  ...
  "body": "Sketch the graph    Without a calculator, sketch the first two periods of the graph of the function .  Which graph below A-E matches your sketch?   E    A    C    Choose    D    B              A  B            C  D           E      (Click on a graph to enlarge it)   SOLUTION The function has midline and amplitude . Since , the period is Since this is a cosine function with a negative value for the parameter , when the graph is at its minimum value. Therefore the correct answer is graph D .      "
},
{
