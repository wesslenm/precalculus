...
},
{
  ...
  "body": " Dividing rational expressions   Divide the rational expressions and simplify the answer:          Multiply numerators separately, then denominators separately, as described in .   Note that it is important to use brackets, to show that all of is multiplied by all of (and similarly for the denominator). Next, expend the brackets and simplify:  . There is no further simplification that can be made. So the answer is    "
},
{
  "id": "sec-alg-rational-6-14",
  "level": "2",
  "url": "sec-alg-rational.html#sec-alg-rational-6-14",
  "type": "Checkpoint",
  "number": "1.10",
  "title": "",
...
},
{
  ...
  "body": " Subtracting rational expressions   Subtract the rational expressions and simplify the answer:        We need find a common denominator. We could use an common denominator. For example we could simply use , but this means we need to expand these brackets and it would lead to high answers in the answer, which may be difficult to simplify. It is often more efficient to use the Least Common Decominator (LCD). To find the LCD, we first facor both denominators:    This means the LCD is   Next, multiply the first rational expression by and the second rational expression by so that both are on the same common denominator. Note that multiplying by is the same as multiplying by 1. It does not change the value of the expression, it just re-writes it in a different format.  . So the answer is It is ok to leave the answer in this format, or to expand the denominator (or factor the numerator if you prefer).   "
},
{
...
},
{
  ...
  "body": " Double exponents  For example, we can say that and that But it is important to note that .  "
},
{
  "id": "sec-exp-intro-7-8",
  "level": "2",
  "url": "sec-exp-intro.html#sec-exp-intro-7-8",
  "type": "Example",
  "number": "3.12",
...
{
  "id": "sec-exp-intro-7-10",
  "level": "2",
  "url": "sec-exp-intro.html#sec-exp-intro-7-10",
  "type": "Checkpoint",
  "number": "3.14",
  "title": "",
