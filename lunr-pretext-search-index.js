...
},
{
  ...
  "number": "3.86",
  "title": "Correct or incorrect?",
  "body": "Correct or incorrect?   Have a look at the following reasoning. Is this correct or incorrect? If it is incorrect, find all mistakes.  Question: Evaluate   'Solution': Now, let so that and . By using a special triangle in Quadrant IV, we see that and .  Therefore so then     It is incorrect.    The `solution' is incorrect. The first line is incorrect, because Instead, solve the problem similarly to . The correct final answer is    "
},
{
