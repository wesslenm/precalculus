...
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs.",
  "body": "Exponential graphs    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   D    C    A    B     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
...
},
{
  ...
  "body": "Largest value for    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   B    A    C    D     (Click on graph to enlarge)   SOLUTION The function with the largest should be the one that is increasing the fastest. We note that C increases faster than the others, so C has the largest .      "
},
{
...
},
{
  ...
  "body": "Definitions of , and   Use the above basic trigonometric identities and definitions to find the definitions of secant, cosecant and cotangent. Do this first in terms of right angled triangles, then in terms of in a circle.       We know that Therefore, in terms of right angled triangles,   opposite   adjacent   hypothenuse  \/  opposite   adjacent   hypothenuse  .    In right angled triangles,   opposite   adjacent   hypothenuse  \/  opposite   adjacent   hypothenuse  .    In right angled triangles,   opposite   adjacent   hypothenuse  \/  opposite   adjacent   hypothenuse  .    In terms of on a circle, we see that   x   y   r  \/  x   y   r  .    In terms of on a circle,   x   y   r  \/  x   y   r  .    In terms of on a circle, we see that   x   y   r  \/  x   y   r  .                                                                     "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "3.2.5.2",
  "title": "Find period, amplitude, phase shift - HOMEMADE - UPDATED.",
  "body": "Find period, amplitude, phase shift - HOMEMADE - UPDATED    Find the following for the function  (a) What is the period of   (b) What is the amplitude of   (c) What is the phase shift of  (Use a positive number for a shift to the right, and negative for to the left.)  (d) What is the midline of                             "
},
{
...
},
{
  ...
  "body": "Find the function    Below is the graph of the function in blue, and a second sinusoidal function in red, which is a horizontal shift of . Find a formula for the function .     (Click on graph to enlarge)        SOLUTION Since graph has been shifted by of a period, the phase shift is . Therefore the formula for is:       "
},
{
...
},
{
  ...
  "body": "Sketch the graph    Without a calculator, sketch the first two periods of the graph of the function .  Which graph below A-E matches your sketch?   E    A    C    B    Choose    D              A  B            C  D           E      (Click on a graph to enlarge it)   SOLUTION The function has midline and amplitude . Since , the period is Since this is a cosine function with a negative value for the parameter , when the graph is at its minimum value. Therefore the correct answer is graph D .      "
},
{
...
},
{
  ...
  "number": "3.3",
  "title": "",
  "body": "   Evaluate trigonomtric functions using special triangles.    Evaluate trigonomtric functions using the coordinate system and the unit circle.    Evaluate trigonomtric functions using graphs.    Choose an appropriate method to evaluate a trigonomtric function at a given angle.    "
},
{
  "id": "fig-special",
  "level": "2",
...
},
{
  ...
  "body": "Evaluate using special triangles 1    Use the special triangles to find the following values. Answer in exact form (using square roots if needed).  (a)  .  (b)  .  (c)  .                      "
},
{
  ...
  "body": "Evaluate using special triangles 2    Use the special triangles to find the following values. Answer in exact form (using square roots if needed).  (a)  .  (b)  .  (c)  .                      "
},
{
  ...
  "body": "Evaluate using special triangles 3    Use the special triangles to find the following values. Answer in exact form (using square roots if needed).  (a)  .  (b)  .  (c)  .                      "
},
{
  "id": "trig-intro-ex4",
  "level": "2",
...
},
{
  ...
  "body": "Evaluate at    Evaluate the following. Answer in exact form (using square roots if needed).  (a)  .  (b)  .  (c)  .  (d)  .                           "
},
{
...
},
{
  ...
  "body": "Evaluate    Evaluate without using a calculator.             "
},
{
  "id": "sec-trig-right-9",
  "level": "2",
...
},
{
  ...
  "number": "3.51",
  "title": "Simplify.",
  "body": "Simplify   (Not randomizable)     Simplify the expression as much as possible and write your final answer in terms of and only.   .            "
},
{
...
},
{
  ...
  "type": "Checkpoint",
  "number": "3.56",
  "title": "Comparing graphs - NOT COMPLETE.",
  "body": "Comparing graphs - NOT COMPLETE   (Not randomizable)     Use DESMOS or some other graphing calculator to graph each pair of expressions. Do they appear to be equivalent? (For those that appear equivalent, can you prove that they are?)    and    The graphs look different, so the expressions are definitely not equal    The graphs look the same, so the expressions may be equal      and    The graphs look different, so the expressions are definitely not equal    The graphs look the same, so the expressions may be equal      and    The graphs look different, so the expressions are definitely not equal    The graphs look the same, so the expressions may be equal      and    The graphs look different, so the expressions are definitely not equal    The graphs look the same, so the expressions may be equal                               "
},
{
  ...
  "number": "3.4.5.1",
  "title": "Evaluate.",
  "body": "Evaluate   (Not randomizable)     Suppose that for some angle we know that and Answer the following questions.   Evaluate = .    Evaluate = .    Evaluate = .    The terminal side of angle is in quadrant  I   II   III   IV  .                             "
},
{
