...
},
{
  ...
  "body": "Exponential graphs - FROM WEBWORK    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   D    C    A    B     (Click on graph to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the function with the greatest -intercept, , has the largest .      "
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs - FROM WEBWORK.",
  "body": "Exponential graphs - FROM WEBWORK    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   D    A    B    C     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
