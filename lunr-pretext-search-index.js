...
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs.",
  "body": "Exponential graphs    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   A    B    C    D     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
...
},
{
  ...
  "number": "2.1.5.1",
  "title": "True or False?",
  "body": "True or False?   (Not randomizable)     Remember that is a real number (a constant). You may see it most often as part of an exponential function such as but itslf is just a number. Which of the following statements about the number are true, and which are false? Try to answer all of them without using a calculator .      True   False       True   False       True   False       True   False     is positive for all real numbers   True   False       True   False                                        "
},
{
...
},
{
  ...
  "body": "Equal value for    Consider the four functions graphed in the figure below, and assume the equations for A , B , C , and D , can all be written in the form .  Which two functions have the same value for ?   BD    AB    BC    AD    CD    AC     (click on image to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the two functions with the same y -intercept, are B and D.      "
},
{
  ...
  "body": "Largest value for    Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   C    B    A    D     (Click on graph to enlarge)   SOLUTION The function with the largest should be the one that is increasing the fastest. We note that C increases faster than the others, so C has the largest .      "
},
{
...
},
{
  ...
  "body": "Sketch the graph    Without a calculator, sketch the first two periods of the graph of the function .  Which graph below A-E matches your sketch?   B    D    Choose    C    A    E              A  B            C  D           E      (Click on a graph to enlarge it)   SOLUTION The function has midline and amplitude . Since , the period is Since this is a cosine function with a negative value for the parameter , when the graph is at its minimum value. Therefore the correct answer is graph D .      "
},
{
