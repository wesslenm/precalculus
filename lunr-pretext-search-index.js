...
},
{
  ...
  "body": "Exponential graphs   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   D    C    B    A     (Click on graph to enlarge)   SOLUTION Since when in , is the -intercept. Thus, the function with the greatest -intercept, , has the largest .      "
},
{
  ...
  "number": "2.5",
  "title": "Exponential graphs.",
  "body": "Exponential graphs   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the smallest value for ?   D    C    A    B     (Click on graph to enlarge)   SOLUTION The function with the smallest should be the one that is decreasing the fastest. We note that D decreases faster than the others, so D has the smallest .      "
},
{
...
},
{
  ...
  "body": "Largest value for   (Not randomizable)     Consider the four functions graphed in the figure below, and assume the equations for A, B, C, and D can all be written in the form .  Which function has the largest value for ?   D    B    A    C     (Click on graph to enlarge)   SOLUTION The function with the largest should be the one that is increasing the fastest. We note that C increases faster than the others, so C has the largest .      "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "2.2.5.5",
  "title": "Function characteristics  - need to finish.",
  "body": "Function characteristics - need to finish   (Not randomizable)       The graph of a logarithmic function is given above. Answer the following questions about that graph.   What is the domain of the function, in interval notation? .    What is the range of the function, in interval notation? .    What is the -intercept of the function? . (Enter your answer in point form, for example )    What is the equation of the vertical asymptote? The vertical asymptote is  . (Enter a single number.)                             "
},
{
  "id": "sec-exp-log-10-3",
  "level": "2",
...
},
{
  ...
  "body": "Sketch the graph    Without a calculator, sketch the first two periods of the graph of the function .  Which graph below A-E matches your sketch?   E    A    C    B    D    Choose              A  B            C  D           E      (Click on a graph to enlarge it)   SOLUTION The function has midline and amplitude . Since , the period is Since this is a cosine function with a negative value for the parameter , when the graph is at its minimum value. Therefore the correct answer is graph D .      "
},
{
